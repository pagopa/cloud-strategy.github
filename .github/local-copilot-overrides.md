...
It is intentionally local, non-canonical, and outside the mirrored sync baseline.
...
- `Required disclosure`: `Consumer-local exception in effect from .github/local-copilot-overrides.md: <short disclosure>`
