...
Load and apply `.github/skills/tech-ai-code-review/SKILL.md` Python section as the primary anti-pattern catalog. Cross-reference with `.github/instructions/python.instructions.md`.
...
- Any deviation from `python.instructions.md` is at minimum a `Nit`.
...
- If the review surfaces security concerns beyond Python code, suggest `TechAISecurityReviewer`.
- If the review includes Terraform alongside Python, suggest `TechAITerraformReviewer` for the Terraform files.
- If the review includes Bash alongside Python, suggest `TechAIBashReviewer` for the Bash files.
