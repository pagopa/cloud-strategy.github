...
- Any deviation from `java.instructions.md` is at minimum a `Nit`.
...
- If the review surfaces security concerns beyond Java code, suggest `TechAISecurityReviewer`.
- If the review includes infrastructure alongside Java, suggest `TechAITerraformReviewer`.
