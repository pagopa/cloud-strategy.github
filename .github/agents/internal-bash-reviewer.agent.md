...
Load and apply `.github/skills/internal-code-review/SKILL.md` Bash section as the primary anti-pattern catalog. Cross-reference with `.github/instructions/internal-bash.instructions.md`.
...
- Any deviation from `internal-bash.instructions.md` is at minimum a `Nit`.
...
- If the review surfaces security concerns beyond Bash code, suggest `internal-security-reviewer`.
- If the review includes Python alongside Bash, suggest `internal-python-reviewer` for the Python files.
- If the review includes Terraform alongside Bash, suggest `internal-terraform-reviewer` for the Terraform files.
