...
Usage examples:
    ./.github/tools/run.sh validate-github-catalog --root .
    ./.github/tools/run.sh validate-github-catalog --root . --skip-token-risks
    ./.github/tools/run.sh validate-github-catalog --root . --token-risks-only
"""
