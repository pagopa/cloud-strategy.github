...
Usage examples:
    ./.github/tools/run.sh validate-internal-skills
    ./.github/tools/run.sh validate-internal-skills --strict --format json
    ./.github/tools/run.sh validate-internal-skills --skill internal-python-script --skill internal-terraform
"""
...
from skills.rules import detect_internal_skill_findings
