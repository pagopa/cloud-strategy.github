...
name: internal-pair-architect-analysis
agent: internal-pair-architect
...
1. Read `.github/skills/internal-pair-architect/SKILL.md` and use it as the complete analysis framework (dimensions, severity mappings, health score, report template, modes, validation).
2. If `.github/skills/internal-code-review/SKILL.md` exists, use it as anti-pattern reference for the Errors section.
...
## Validation
- Keep `.github/skills/internal-pair-architect/SKILL.md` as the referenced analysis framework.
