...
Usage examples:
    python3 ./.github/scripts/validate-github-catalog.py --root .
    python3 ./.github/scripts/validate-github-catalog.py --root . --skip-token-risks
    python3 ./.github/scripts/validate-github-catalog.py --root . --token-risks-only
"""
