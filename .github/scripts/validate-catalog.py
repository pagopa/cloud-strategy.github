...
Usage examples:
    python3 ./.github/scripts/validate-catalog.py --root .
    python3 ./.github/scripts/validate-catalog.py --root . --include-token-risks --strict
        python3 ./.github/scripts/validate-catalog.py --root . --deep
