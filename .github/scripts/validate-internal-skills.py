...
Usage examples:
    python3 ./.github/scripts/validate-internal-skills.py
    python3 ./.github/scripts/validate-internal-skills.py --strict --format json
    python3 ./.github/scripts/validate-internal-skills.py --skill internal-python-script --skill internal-terraform
"""
