...
| `source-invalid-agents-md` | Root `AGENTS.md` lacks the shared policy baseline required for safe projection. | Restore the shared baseline before updating `~/.agents/AGENTS.md`; `AGENTS.local.md` is optional and is not synchronized. |
