...
**Save plans to:** `tmp/superpowers/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `tmp/superpowers/plans/<filename>.md`. Please review the plan. Which execution approach would you prefer?**
...
**"Plan complete and saved to `tmp/superpowers/plans/<filename>.md`. Please review the plan. Does it capture what you want?"**
