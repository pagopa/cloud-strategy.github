...
- `internal-gateway-idea`: target lane when planning or scope definition is needed.
...
| `internal-gateway-review` | Findings reopen planning or scope definition | `internal-gateway-idea` |
