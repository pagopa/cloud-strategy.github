...
```json
{
  ...
  "hashing": {"content_sha256": {"algorithm": "SHA-256", "input": "exact retained-plan bytes", "binding": "external"}, "semantic_fingerprint": {"algorithm": "SHA-256", "input": "RFC 8785 canonical Execution Manifest JSON with top-level delegation subtree excluded", "version": "semantic-fingerprint/v1", "binding": "external"}, "self_reference": false},
