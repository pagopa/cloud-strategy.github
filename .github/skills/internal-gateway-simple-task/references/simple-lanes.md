...
| `escalate` | The task becomes staged, review-owned, retained-plan-owned, or critical-challenge owned. | Stop and name the next owner. | Provide boundary break, owner, scope, action, validation path, and risk. |
