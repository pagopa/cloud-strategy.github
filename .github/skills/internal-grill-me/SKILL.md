---
name: internal-grill-me
description: Use only when explicitly invoking the legacy bulk interview contract for a plan or design.
---
...
- Use only when the user explicitly requests `/internal-grill-me` and its
  legacy bulk interview format.
