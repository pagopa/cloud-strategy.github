...
| `define-first` | `operational-clarify-first`, `confirm-scope-first`, `confirm-success-criteria` |
...
- Substantive idea, concept, ideation, or discovery prompts belong to `internal-gateway-idea-brainstorming`.
