...
- Strict skill validation: `./.github/tools/run.sh validate-internal-skills --skill local-sync-repos --strict`
- Catalog consistency: `./.github/tools/run.sh validate-catalog --root . --include-token-risks`
