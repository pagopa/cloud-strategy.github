...
[Read plan once: tmp/superpowers/plans/feature-plan.md; spec read]
[Resolve workspace: sdd-workspace tmp/superpowers/plans/feature-plan.md — no ledger inside, fresh start]
