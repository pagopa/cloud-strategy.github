...
[Read plan file once: tmp/superpowers/plans/feature-plan.md]
[Resolve workspace: bash scripts/sdd-workspace tmp/superpowers/plans/feature-plan.md — no ledger inside, fresh start]
