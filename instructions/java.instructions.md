...
## Mandatory rules
- Start script-like entrypoints with a top-level JavaDoc that explains purpose and usage examples.
...
- Unit tests are required for testable logic (JUnit 5).
 ...
 *   java -jar app.jar --input data.json
 */
